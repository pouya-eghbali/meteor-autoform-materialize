...
// Hard forked from https://github.com/icefox0801/materialize-autocomplete
(function (root, factory) {
    ...
    Autocomplete.prototype = {
        ...
        initialize: function () {
            ...
            // figure out what items to show on the dropdown
            ...
            if (self.options.value) {
              console.log('init set autocomplete val:', self.options.value);
              self.value = self.options.value;
              if (self.options.multiple.enable && _.isArray(self.value)) {

                _.each( self.value, (val) => {
                  console.log('init appending val', val);
              ...
              console.log('init autocomplete value to empty');
        ...
        remove: function (item) {
            ...
            if(self.options.hidden.enable) {
              self.$hidden.find('option[value="'+item.id+'"]').
                  removeAttr('selected');
            }
